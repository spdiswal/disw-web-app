...
. In the `main/content` folder, create a TypeScript file named e.g. `my-profile.local.tsx` which must export the profile name (to be displayed in the title bar) and three function components:
+
----
