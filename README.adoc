...
To load the correct profile into the web app, the Vite configuration defines `+profile/content` to be an alias for the TypeScript module designated by `VITE_PROFILE_NAME`.
